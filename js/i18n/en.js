...
export default {
  ...
  "ui.stepUvSnapHeading": "CAD Face UV Periodic Snap",
  "ui.stepUvSnapDesc": "A CAD face that wraps fully around itself (a full cylinder, a torus) has an internal seam where the pattern can jump. When on, each such face's tile size is nudged to the nearest value that divides its own wrap evenly, at the cost of a slightly different effective tile size from face to face. When off, all faces use your exact requested size, but wrapping faces may show a seam.",
  "ui.stepUvSnap": "Snap tile size to close periodic-face seams",
  "ui.stepUvAnchorHeading": "CAD Face UV Pattern Anchor",
  "ui.stepUvAnchorDesc": "Pick two boundary faces (e.g. the flat sides bordering a curved patch). The pattern on the textured faces between them is snapped so a whole number of tiles fits exactly, with matching phase at both ends — useful for a span that doesn't wrap on itself but should still start and end cleanly.",
  "ui.stepUvAnchorPick": "Pick Anchor Faces",
  "tooltips.stepUvAnchorPick": "Click this, then click two boundary faces in the viewport.",
  "ui.stepUvAnchorClear": "Clear",
  "ui.stepUvAnchorNone": "No anchor set — pattern uses its normal automatic phase alignment.",
  "ui.stepUvAnchorPickingA": "Click the first boundary face…",
  "ui.stepUvAnchorPickingB": "Anchor A: {a} — now click the second boundary face…",
  "ui.stepUvAnchorSet": "Anchor A: {a}  ·  Anchor B: {b}",
  "ui.stepUvAnchorNoPath": "Anchor A: {a}  ·  Anchor B: {b}  — no textured faces connect them; anchor has no effect.",
  ...
  "excl.basisMesh": "Mesh",
  "excl.basisMeshTitle": "Select mesh triangles by hand (brush / fill), same as any other file format",
  "excl.basisStep": "STEP Face",
  "excl.basisStepTitle": "Click once to select a whole CAD surface from the original STEP file",
  "excl.stepFaceHint": "Click a surface to select the whole CAD face.",
